...
with DAG(
    ...
    t1 = DataTransferPostgres(
        ...
        task_id='customer',
        source_pg_conn_str=source_pg_conn_str, #"host='db1' port=5432 dbname='my_database_1' user='root' password='postgres'",
        pg_conn_str=pg_conn_str, #"host='db2' port=5432 dbname='my_database_2' user='root' password='postgres'",
        )
